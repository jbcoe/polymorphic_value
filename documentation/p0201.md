...
[Note 2: This constructor can allow an implementation to avoid the need for
dynamic memory allocation. - end note]
...
[Note 3: move construction of an owned object may be used by an implementation to
...
[Note 4: Implementations are encouraged to avoid multiple allocations. - end note]
